...
<div className="wrapper">
  ...
  <aside className="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" className="brand-link">
      <img src="/User/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" className="brand-image img-circle elevation-3" style={{opacity: '.8'}} />
    ...
    <div className="sidebar">
      ...
      <div className="user-panel mt-3 pb-3 mb-3 d-flex">
        <div className="image">
          <img src="/User/dist/img/user2-160x160.jpg" className="img-circle elevation-2" alt="User Image" />
        </div>
        <div className="info">
      ...
      <nav className="mt-2">
       ...
       with font-awesome or any other icon font library */}
          <li className="nav-item ">
            <Link to={"/admin"} className="nav-link "><i className="nav-icon fas fa-tachometer-alt" />
              <p>
                Dashboard
              </p></Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link"  to={"/admin/product"}> <p>
                 <i className="fa fa-book"></i> Products
                <span className="right badge badge-danger">New</span>
              </p></Link>
          
          </li>
          <li className="nav-item">
            <Link className="nav-link"  to={"/admin/product/type"}> <p>
                 <i className="fa fa-book"></i> Product Type
              </p></Link>
