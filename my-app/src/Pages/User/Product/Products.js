                            ...
                            <nav className="product__sidebar-list">
                                <div className="row">
                                    <div className="product__sidebar-item col-lg-6">
                                        <img
                                            src="/User/images1/item/sachGK.png"
                                            alt=""
                                    ...
                                    <div className="product__sidebar-item col-lg-6">
                                        <img
                                            src="/User/images1/item/tieuthuyet.png"
                                            className="product__sidebar-item-img"
                                        />
                                        <a href="" className="product__sidebar-item-name">
                                            Tiểu Thuyết
                                    ...
                                    <div className="product__sidebar-item col-lg-6">
                                        <img
                                            src="/User/images1/product/twd2_biaao_demo.jpg"
                                            alt=""
                                            className="product__sidebar-item-img"
                                        />
                                        <a href="" className="product__sidebar-item-name">
                                    ...
                                    <div className="product__sidebar-item col-lg-6">
                                        <img
                                            src="/User/images1/product/8936054081882.jpg"
                                            alt=""
                                            className="product__sidebar-item-img"
                                        />
                                        <a href="" className="product__sidebar-item-name">
                        ...
                        <article className="product__content col-lg-9 col-md-12 col-sm-12">
                            ...
                            <div className="pagination" style={{marginTop:"1rem"}}>
                                <ul className="pagination__list">
                                    {currentPage > 1 && (
                                        <a className="pagination__item" onClick={() => paginate(currentPage - 1)}>
                                            &laquo;
                                        </a>
                                    )}
                                    {Array.from({ length: Math.ceil(Product.length / productsPerPage) }).map((_, index) => (
                                        <a key={index} className={`pagination__item ${currentPage === index + 1 ? 'active' : ''}`} onClick={() => paginate(index + 1)}>
                                            <button className="pagination__link" >{index + 1}</button>
                                        </a>
                                    ))}
