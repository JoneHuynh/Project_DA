...
namespace API_Server.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(UserManager<User> userManager, RoleManager<IdentityRole> roleManager, IConfiguration configuration, BookStoreIdentity_Context context, IWebHostEnvironment webHostEnvironment)
        {
